...
<div class="container">
        <div id="header">
            <h1 style="color: #003399;" align="center">DASHBOARD OPERATOR PERPUS UIN</h1>
    ...
    <div id="sidebar">
        ...
        <ul id="navmenu">
            ...
            <li><a href="?module=viewBukuOperator#pos">view Buku</a></li>
            <li><a href="?module=insertBukuOperator#pos">Insert Buku</a></li>
            <li><a href="?module=insertPinjamOperator#pos">Insert Pinjaman</a></li>
            <li><a href="?module=viewPinjamOperator#pos">View Pinjaman</a></li>
        ...
        <div id="page">
            <?php if(isset($_GET['module']))
                ...
                include "konten/homeOperator.php";?>
